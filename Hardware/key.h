...
#define KEY1 			(DL_GPIO_readPins(KEY_KEY1_PORT,KEY_KEY1_PIN)==KEY_KEY1_PIN)?1:0
#define KEY2 			(DL_GPIO_readPins(KEY_KEY2_PORT,KEY_KEY2_PIN)==KEY_KEY2_PIN)?1:0
#define KEY3 			(DL_GPIO_readPins(KEY_KEY3_PORT,KEY_KEY3_PIN)==KEY_KEY3_PIN)?1:0
